package com.example.spring.boot2.simple.security.v6.web.util;
...
public final class UrlUtils {
     ...
     * hence the decoded form is used in preference to the requestURI for building the returned value. But this method may also be called using dummy request objects which just
     * have the requestURI and contextPatth set, for example, so it will fall back to using those.
     *
