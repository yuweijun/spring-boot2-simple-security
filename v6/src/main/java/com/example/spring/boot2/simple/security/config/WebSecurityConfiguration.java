...
import com.example.spring.boot2.simple.security.access.expression.method.DefaultMethodSecurityExpressionHandler;
import com.example.spring.boot2.simple.security.access.expression.method.ExpressionBasedAnnotationAttributeFactory;
import com.example.spring.boot2.simple.security.access.expression.method.ExpressionBasedPreInvocationAdvice;
import com.example.spring.boot2.simple.security.access.expression.method.MethodSecurityExpressionHandler;
import com.example.spring.boot2.simple.security.access.intercept.aopalliance.MethodSecurityInterceptor;
import com.example.spring.boot2.simple.security.access.method.MethodSecurityMetadataSource;
import com.example.spring.boot2.simple.security.access.prepost.PrePostAnnotationSecurityMetadataSource;
import com.example.spring.boot2.simple.security.access.vote.AffirmativeBasedDecisionManager;
import com.example.spring.boot2.simple.security.config.method.configuration.EnableGlobalMethodSecurity;
...
import com.example.spring.boot2.simple.security.access.prepost.PreInvocationAuthorizationAdviceVoter;
...
import com.example.spring.boot2.simple.security.web.HttpSecurity;
import com.example.spring.boot2.simple.security.web.authentication.AuthenticationManager;
import com.example.spring.boot2.simple.security.web.authentication.dao.DaoAuthenticationProvider;
